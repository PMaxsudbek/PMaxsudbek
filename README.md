...
<h5 align="left">
  ...
  <a href="https://www.hackerrank.com/profile/pardayevmahsud" title="HackerRank Profile" target="_blank">
    <div style="width: 50px; height: 50px; background-color: black; display: flex; align-items: center; justify-content: center;">
      <img width="40" src="https://hrcdn.net/fcore/assets/brand/logo-new-white-green-a5cb16e0ae.svg" alt="HackerRank Logo">
    </div>
  </a>
</h5>
